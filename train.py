...
# 训练函数
def train_model(model, train_loader, val_loader, criterion, optimizer, device, num_epochs, checkpoint_path, resume=False):
...
def main():
    ...
    parser.add_argument('--csv_file', type=str, default='data/experiment_data.csv', 
    ...
    train_model(model, train_loader, val_loader, criterion, optimizer, device, 
                args.num_epochs, args.checkpoint_path, args.resume)
